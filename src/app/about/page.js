      ...
      <div className="w-screen h-fit bg-black flex justify-center items-center">
        <div className="max-w-[1225px] h-full w-full max-w-[1225px] bg-zinc-900 flex overflow-hidden flex-col lg:flex-row min-h-screen">
          ...
          <div className="w-full lg:w-1/2 h-full mt-20 px-6 sm:px-10 md:px-20 lg:px-10 mb-0 lg:mb-16 lg:mt-36">
            ...
            >
              From an early age, I’ve been driven by a passion for problem
              solving and innovation. Whether I'm building solutions for 5
              people or 5000, I’ve always sought opportunities to make a
              difference through technology and creativity. This mindset has
              fueled a series of opportunities that have allowed me to develop
              impactful skills and pursue meaningful endeavors, all of which
              have shaped my personal and professional growth.
            </div>
